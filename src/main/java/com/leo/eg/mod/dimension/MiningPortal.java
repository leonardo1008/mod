...
public class MiningPortal extends BlockBreakable
{
    ...
    {
        MiningPortal.Size blockportal$size = new MiningPortal.Size(worldIn, p_176548_2_, EnumFacing.Axis.X);
        ...
        {
            MiningPortal.Size blockportal$size1 = new MiningPortal.Size(worldIn, p_176548_2_, EnumFacing.Axis.Z);
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
    {
        ...
        if (enumfacing$axis == EnumFacing.Axis.X)
        {
            MiningPortal.Size blockportal$size = new MiningPortal.Size(worldIn, pos, EnumFacing.Axis.X);
        ...
        {
            MiningPortal.Size blockportal$size1 = new MiningPortal.Size(worldIn, pos, EnumFacing.Axis.Z);
    ...
    public BlockPattern.PatternHelper func_181089_f(World p_181089_1_, BlockPos p_181089_2_)
    {
        ...
        MiningPortal.Size blockportal$size = new MiningPortal.Size(p_181089_1_, p_181089_2_, EnumFacing.Axis.X);
        ...
        if (!blockportal$size.func_150860_b())
        {
            ...
            blockportal$size = new MiningPortal.Size(p_181089_1_, p_181089_2_, EnumFacing.Axis.Z);
        }
    ...
    public static class Size
        {
            ...
            protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
            {
                ...
                for (i = 0; i < 22; ++i)
                {
                    ...
                    if (!this.func_150857_a(this.world.getBlockState(blockpos).getBlock()) || this.world.getBlockState(blockpos.down()).getBlock() != NewModBlocks.good_block)
                    {
                        break;
                    }
                }
                ...
                return block == NewModBlocks.good_block ? i : 0;
            }
            ...
            protected int func_150858_a()
            {
                ...
                for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
                {
                    for (int i = 0; i < this.field_150868_h; ++i)
                    {
                        ...
                        if (block == NewModBlocks.mining_portal)
                        {
                            ++this.field_150864_e;
                        }
                        ...
                        if (i == 0)
                        {
                            ...
                            if (block != NewModBlocks.good_block)
                            {
                                break label24;
                            }
                        }
                ...
                {
                    if (this.world.getBlockState(this.field_150861_f.offset(this.field_150866_c, j).up(this.field_150862_g)).getBlock() != NewModBlocks.good_block)
                    {
            ...
            {
                return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == Blocks.fire || p_150857_1_ == NewModBlocks.mining_portal;
            }
            ...
            public void func_150859_c()
            {
                for (int i = 0; i < this.field_150868_h; ++i)
                {
                    ...
                    {
                        this.world.setBlockState(blockpos.up(j), NewModBlocks.mining_portal.getDefaultState().withProperty(MiningPortal.AXIS, this.axis), 2);
                    }
                }
            }
        }
